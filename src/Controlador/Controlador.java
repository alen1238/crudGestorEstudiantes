...
public class Controlador implements ActionListener{
    ...
    public void add(){
        ...
        if(fila == 1){
            JOptionPane.showMessageDialog(vista, "Estudiante agregado exitosamnte");        
        }else{
    ...
    public void Actualizar(){
        if(vista.txtId.getText().equals("")){
            ...
            if(fila == 1){
                JOptionPane.showMessageDialog(vista, "Estudiante actualizado con éxito");              
            }else{
                JOptionPane.showMessageDialog(vista, "Error");
            }
        }
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource() == vista.btnAgregar){
            if(vista.txtNombre.getText().equals("") || vista.txtCorreo.getText().equals("")
                ...
                JOptionPane.showMessageDialog(vista, "No se permite agregar datos vacíos.");
            }
            else{
                add();
                listar(vista.tabla);
